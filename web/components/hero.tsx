              ...
              via-pink-500 to-indigo-500 bg-[length:400%] bg-clip-text
               text-transparent"
                        ...
                        <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-slate-500">
                            All the Microsoft animated fluent emojis are
                            available in one place and ready to use in your next
                        ...
                        <Alert className="my-4">
                            ...
                            <AlertDescription>
                                Demanding Palestine&apos;s Freedom & Global
                                Support
                            </AlertDescription>
                        </Alert>
                        <div className="mx-auto flex w-full max-w-2xl flex-col justify-center gap-2 sm:flex-row">
                            <div className="mt-3 rounded-lg sm:mt-0">
                                <a
                                    href="https://github.com/insertfahim/Animated-Fluent-Emojis"
                                    className={buttonVariants({
                                        variant: "default",
                                        size: "lg",
                                    })}
                                >
                                    <DocumentTextIcon className="mr-1.5 h-5 w-5" />{" "}
                                    Documentation
                                </a>
                            </div>
                            <div className="mt-3 rounded-lg sm:mt-0 sm:ml-3">
                                <a
                                    href="https://github.com/insertfahim/Animated-Fluent-Emojis/tree/master/Emojis"
                                    className={buttonVariants({
                                        variant: "secondary",
                                        size: "lg",
                                    })}
                            ...
                            <div className="mt-3  rounded-lg sm:mt-0 sm:ml-3">
                                <a
                                    href="https://telegram-emoji.vercel.app/"
                                    className={buttonVariants({
                                        variant: "secondary",
                                        size: "lg",
                                    })}
